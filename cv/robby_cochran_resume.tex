...
{\small Staff Engineer / Engineering Manager - Runtime Security, Kubernetes, eBPF, Software Verification, AI-Agent Safety}\\[-1pt]
...
\begin{itemize}
  ...
  \item Current thesis: enterprise AI systems need runtime contracts, evaluation harnesses, observability, policy, and behavior-level security controls around agents - not just model-level safety.
\end{itemize}
